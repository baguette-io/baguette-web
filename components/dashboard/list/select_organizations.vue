<template>
    <div class="dropdown shown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownOrganization" style="padding-bottom: 0">
            <nuxt-link class="dropdown-item" v-if="orga.organization.name !=current" v-for="orga in orgas" :key="orga.name" v-bind:to="'/dashboard/organizations/' + orga.organization.name">
